            ...
            {pantalones.map((pantalon, idx) => (
              ...
              >
                <div className="relative">
                  {pantalon.badge && (
                    <div className={`absolute top-2 left-2 px-2 py-1 text-xs font-bold rounded z-10 ${pantalon.badge === "40% OFF" ? "bg-yellow-400 text-black" :
                ...
                <div className="p-4">
                  ...
                  <button
                    onClick={() =>
                      handleAddToCart({
                        productId: `gorra-${pantalon.id}`,
                        name: pantalon.name,
                        price: pantalon.price,
                        quantity: 1,
                        image: pantalon.image,
                      })
                    }
